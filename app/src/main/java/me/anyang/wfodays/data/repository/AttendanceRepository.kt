...
class AttendanceRepository @Inject constructor(
    ...
    suspend fun getMonthlyStatistics(yearMonth: YearMonth): MonthlyStatistics {
        ...
        val wfhDays = records.count { it.workMode == WorkMode.WFH }
        ...
        // Get target percentage from preferences (default 30%)
        val targetPercentage = preferencesManager.wfoTargetPercentage.first()
        val requiredDays = kotlin.math.ceil(effectiveWorkdays * (targetPercentage / 100.0)).toInt()
